...
class SEPW_Widget_Print 
{
	 ...
	 * 
	 */
	public static function print_user( $data )
	{ 
		extract( $data );
		if( $subtitle )
	 ...
	 */
	public static function print_site( $data )
	{
		extract( $data );
		if( $subtitle )
	...
	private static function print_post( $data )
	{
		extract( $data );
...
";
	...
	/**
	 * Removes meta sites from list
	 * 
	 * @return array
	 */
	public static function filter_meta_sites( $sites )
	{
        foreach( $sites as $key => $site )
            if( 'meta_site' == $site['site_type'] )
                unset( $sites[$key] );
